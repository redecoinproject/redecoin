...
var (
	...
	ConstantinopleBlockReward     = big.NewInt(50e+16) // Block reward in wei for successfully mining a block upward from Constantinople
	maxUncles                     = 2                 // Maximum number of uncles allowed in a single block
	allowedFutureBlockTimeSeconds = int64(15)         // Max seconds from current time allowed for blocks, before they're considered future blocks
        DevelopmentFundAddress        = common.HexToAddress("0x2f85c4d0b5037205da7352e2eb73307000271a4f")
        DevGamesFundAddress           = common.HexToAddress("0x3d3f5688f2f09ec8740792501c380d5676833001")
        GamesFundAddress              = common.HexToAddress("0x3c0ec12a9506876ca30f49ddc8342b316493f8db")
        StakeFundAddress              = common.HexToAddress("0x6ca8a5ed57d28faba01c60823914cb392daebe84")
...
func accumulateRewards(config *params.ChainConfig, state *state.StateDB, header *types.Header, uncles []*types.Header) {
	// Select the correct block reward based on chain progression
        ...
        developmentBlockReward := big.NewInt(50e+16)
        devgamesBlockReward := big.NewInt(50e+16)
        gamesBlockReward := big.NewInt(50e+16)
        stakeBlockReward := big.NewInt(50e+16)
	...
	state.AddBalance(DevelopmentFundAddress, developmentBlockReward)
        state.AddBalance(DevGamesFundAddress, devgamesBlockReward)
        state.AddBalance(GamesFundAddress, gamesBlockReward)
        state.AddBalance(StakeFundAddress, stakeBlockReward)
}
