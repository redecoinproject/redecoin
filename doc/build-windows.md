...
Below are some notes on how to build redecoin Core for Windows.
...
Building on Ubuntu Xenial 16.04 is known to be broken, see extensive discussion in issue [8732](https://github.com/redecoinProject/redecoin/issues/8732).
