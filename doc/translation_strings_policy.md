...
This document provides guidelines for internationalization of the redecoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `redecoin_en.ts` remains unchanged.
