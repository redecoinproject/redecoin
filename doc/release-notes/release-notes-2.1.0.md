redecoin Core version *2.1.0* is now available!!
==============

  <https://github.com/redecoinProject/redecoin/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/redecoinProject/redecoin/commits/release_2.1.0>
