redecoin Core version *2.0.4.0* is now available!!
==============

  <https://github.com/redecoinProject/redecoin/releases/tag/v2.0.4>
...
Changelog available here: <https://github.com/redecoinProject/redecoin/commits/release_2.0.4>
