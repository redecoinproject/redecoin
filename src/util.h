 ...
 */
#ifndef REDECOIN_UTIL_H
#define REDECOIN_UTIL_H
...
extern const char *const REDECOIN_CONF_FILENAME;
extern const char *const REDECOIN_PID_FILENAME;
...
{
    std::string s = strprintf("redecoin-%s", name);
