...
#ifndef REDECOIN_QT_REDECOINUNITS_H
#define REDECOIN_QT_REDECOINUNITS_H
...
/** redecoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class redecoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit redecoinUnits(QObject *parent);

    /** redecoin units.
      @note Source: https://en.redecoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        REDE,
...
typedef redecoinUnits::Unit redecoinUnit;

#endif // REDECOIN_QT_REDECOINUNITS_H
