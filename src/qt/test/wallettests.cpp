...
#include "qt/redecoinamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<redecoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_redecoin-qt -platform xcb      # Linux
//     src/qt/test/test_redecoin-qt -platform windows  # Windows
//     src/qt/test/test_redecoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = redecoinUnits::formatWithUnit(unit, balance, false, redecoinUnits::separatorAlways);
    ...
    // Amount input
    redecoinAmountField* amountInput = receiveCoinsDialog.findChild<redecoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: redecoin:")) != -1);
