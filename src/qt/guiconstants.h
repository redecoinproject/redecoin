...
#ifndef REDECOIN_QT_GUICONSTANTS_H
#define REDECOIN_QT_GUICONSTANTS_H
...
/* redecoinGUI -- Size of icons in status bar */
...
/* redecoin dark orange */
#define COLOR_DARK_ORANGE QColor("#f05339")
/* redecoin light orange */
...
/* redecoin shadow color - light mode */
...
/* redecoin label color as a string */
...
#define QAPP_ORG_NAME "redecoin"
#define QAPP_ORG_DOMAIN "redecoin.com"
#define QAPP_APP_NAME_DEFAULT "redecoin-Qt"
#define QAPP_APP_NAME_TESTNET "redecoin-Qt-testnet"

#endif // REDECOIN_QT_GUICONSTANTS_H
