...
#ifndef REDECOIN_QT_REDECOINGUI_H
#define REDECOIN_QT_REDECOINGUI_H
...
/**
  redecoin GUI main class. This class represents the main window of the redecoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class redecoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit redecoinGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~redecoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a redecoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
#endif // REDECOIN_QT_REDECOINGUI_H
