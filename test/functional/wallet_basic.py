...
class WalletTest(redecoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 REDE from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 REDE with subtract fee from amount
        ...
        # Sendmany 10 REDE with subtract fee from amount
