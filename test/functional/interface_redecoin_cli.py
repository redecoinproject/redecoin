...
class TestredecoinCli(redecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `redecoin-cli getinfo`")
        ...
        self.log.info("Compare responses from `redecoin-cli -getinfo` and the RPCs data is retrieved from.")
